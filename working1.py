...
class TemperatureMonitor:
    ...
    def setup_ui(self):
        ...
        note_label = ttk.Label(main_frame, text="Note: All temperatures shown are based on room temperature not the actual Device", 
                              font=("Arial", 9), foreground="blue")
        note_label.grid(row=1, column=0, columnspan=3, pady=(0, 5))
        
        # Sensor status display
        self.sensor_status_var = tk.StringVar()
        sensor_status_label = ttk.Label(main_frame, textvariable=self.sensor_status_var,
                                      font=("Arial", 9), foreground="green")
        sensor_status_label.grid(row=2, column=0, columnspan=3, pady=(0, 5))
        ...
        time_label.grid(row=3, column=0, columnspan=3, pady=(0, 10))
        
        # Storage temperatures display frame
        storage_frame = ttk.LabelFrame(main_frame, text="Storage Device Temperatures", padding="10")
        storage_frame.grid(row=4, column=0, columnspan=3, pady=10, sticky=(tk.W, tk.E))
        ...
        ttk.Label(stats_frame, text="Max Temperature:", 
        ...
        self.status_indicator.grid(row=5, column=2, padx=(10, 0), pady=10)
        ...
        last_update_label = ttk.Label(main_frame, textvariable=self.last_update_var,
                                     font=("Arial", 9), foreground="blue")
        last_update_label.grid(row=7, column=0, columnspan=3, pady=(0, 10))
        
        # Next email report time
        self.next_email_var = tk.StringVar(value="Next email report: --")
        next_email_label = ttk.Label(main_frame, textvariable=self.next_email_var,
                                    font=("Arial", 9), foreground="purple")
        next_email_label.grid(row=8, column=0, columnspan=3, pady=(0, 5))
        
        # Controls frame
        controls_frame = ttk.LabelFrame(main_frame, text="Monitoring Controls", padding="10")
        controls_frame.grid(row=9, column=0, columnspan=3, pady=10, sticky=(tk.W, tk.E))
        ...
        ttk.Button(controls_frame, text="Send Test Email", 
                  command=self.send_test_email).grid(row=0, column=7, padx=5)
        
        # Settings frame
        settings_frame = ttk.LabelFrame(main_frame, text="Temperature Settings (°C) - Adjusted Values", padding="10")
        settings_frame.grid(row=10, column=0, columnspan=3, pady=10, sticky=(tk.W, tk.E))
        ...
        # Temperature graph
        graph_frame = ttk.LabelFrame(main_frame, text="Max Temperature History - Adjusted (Last 60 minutes)", padding="10")
        graph_frame.grid(row=11, column=0, columnspan=3, pady=10, sticky=(tk.W, tk.E, tk.N, tk.S))
